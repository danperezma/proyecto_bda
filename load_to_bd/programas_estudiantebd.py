...
if conexion.is_connected():
    ...
    with open(archivo_csv, newline="", encoding="utf-8") as csvfile:
        ...
        for fila in lector_csv:
            ...
            datos = (fila['idEstudiante'], fila['idPrograma'], datetime.strptime(fila['fechaInicio'], "%m/%d/%Y").strftime("%Y-%m-%d"), datetime.strptime(fila['fechaFin'], "%m/%d/%Y").strftime("%Y-%m-%d"), fila['Modalidad Grado'])  # Ajusta esto según la estructura de tu tabla
