...
if conexion.is_connected():
    ...
    with open(archivo_csv, newline="", encoding="utf-8") as csvfile:
        ...
        for fila in lector_csv:
            ...
            datos = (fila['idEstudiante'], fila['nombre'], fila['sexo'], fila['email'], fila['telefono'], datetime.strptime(fila['fechaNacimiento'], "%m/%d/%Y").strftime("%Y-%m-%d"))  # Ajusta esto según la estructura de tu tabla
